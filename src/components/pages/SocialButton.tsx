...
export default function SocialButton({ provider, onLogin }: SocialButtonProps) {
  ...
  return (
    <button
      onClick={handleClick}
      className="w-full flex items-center gap-3 px-4 py-3 rounded-xl border border-border bg-card hover:bg-secondary transition-colors text-foreground text-sm font-medium"
    >
      {icons[provider]}
